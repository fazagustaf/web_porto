...
/**
 * Smooth scroll untuk anchor link + refresh AOS
 */
document.querySelectorAll('a[href^="#"]').forEach(anchor => {
  anchor.addEventListener('click', function(e) {
    ...
    if (target) {
      ...
      // Ambil offset header dari CSS (scroll-margin-top)
      ...
      // Paksa refresh AOS biar section langsung muncul
      setTimeout(() => {
        AOS.refreshHard();
      }, 800);
    }
...
function aosInit() {
  AOS.init({
    duration: 600,
    easing: 'ease-in-out',
    once: false,   // biar elemen bisa muncul lagi kalau ke-skip
    mirror: false,
    offset: 200    // geser lebih awal supaya section besar kayak contact kebaca semua
  });
}
